...
Council for Scientific and Industrial Research, Pretoria, South Africa (renamed to ZA in 2007-01)
...
Direkcija za mere i dragocene metale (Directorate of Measures and Precious Metals), Belgrade, Serbia
...
Ellyniko Institouto Metrologias (Hellenic Institute of Metrology), Thessaloniki, Greece
...
Instituto Geografico Militar (Military Geographic Institute), Buenos Aires, Argentina (renamed to IGNA in 2009-10)

=item B<IGNA>

Instituto Geografico Nacional (National Geographic Institute), Buenos Aires, Argentina
...
Instituto Nacional de Tecnologia Industrial (National Industrial Technology Institute), Buenos Aires, Argentina
...
Pusat Penelitian Kalibrasi Instrumentasi Dan Metrologi (Research Centre for Calibration Instrumentation and Metrology), Lembaga Ilmu Pengetahuan Indonesia (Indonesian Institute of Sciences), Serpong-Tangerang, Indonesia
...
Latvijas Nacionalais Metrolojiias Centrs (Latvian National Metrology Centre), Riga, Latvia
...
Magyar Kereskedelmi Engedelyezesi Hivatal (Hungarian Trade Licensing Office), Budapest, Hungary
...
National Centre of Metrology, Sofia, Bulgaria (renamed to BIM in 2007-01)
...
United States Naval Research Laboratory, Washington D.C., United States of America
...
Orszagos Meresugyi Hivatal (National Office of Measures), Budapest, Hungary (renamed to MKEH in 2007-01)
...
Slovenski institut za kakovost in meroslovje (Slovenian Institute of Quality and Metrology), Ljubljana, Slovenia

=item B<SMD>

Metrology Division of the Quality and Safety Department - Scientific Metrology, Brussels, Belgium
...
National Science Center Institute of Metrology, Kharkov, Ukraine
...
Zavod za mere i dragocene metale (Bureau of Measures and Precious Metals), Belgrade, Serbia (renamed to DMDM in 2009-10)
...
essentially functional nature as a collection of raw data.  If there is
any copyright on the file that this is based on, it is presumably held
by the BIPM.  Andrew Main does not claim copyright on any part of this
document, and hereby places into the public domain any copyrightable
aspect of it over which he would otherwise hold the copyright.

=head1 LICENSE

No license is required to do anything with public domain materials.
To the extent that the BIPM holds copyright on the file that this is
based on, reproducing certain aspects of it here is probably fair use.
